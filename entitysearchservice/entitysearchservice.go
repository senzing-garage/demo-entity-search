...
// HttpServiceImpl is the default implementation of the HttpServer interface.
...
func (httpService *HttpServiceImpl) populateStaticTemplate(responseWriter http.ResponseWriter, request *http.Request, filepath string, templateVariables TemplateVariables) {
...
func (httpService *HttpServiceImpl) Handler(ctx context.Context) *http.ServeMux {
